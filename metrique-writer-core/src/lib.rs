...
pub use crate::descriptor::{
    DescriptorId, DescriptorRef, EntryDescriptor, FieldDescriptor, FieldShape, FieldTag,
    FieldTagState, FieldView, KnownShape, ShapeRef, StringShape, TimestampDescriptor,
};
